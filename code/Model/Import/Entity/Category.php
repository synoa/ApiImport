    ...
    extends Mage_ImportExport_Model_Import_Entity_Abstract
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'api_import_entity_category';
    ...
    /**
     * Returns an object for uploading media files.
     *
    ...
    public function validateRow(array $rowData, $rowNum)
    {
        ...
        if (self::SCOPE_DEFAULT == $rowScope) { // category is specified, row is SCOPE_DEFAULT, new category block begins
            ...
            if (!isset($this->_categoriesWithRoots[$root][$category])) { // validate new category type and attribute set
